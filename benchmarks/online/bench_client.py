...
def process_benchmark_results(results: list[RawResult]) -> dict[str, float]:
    ...
    summary = {
        ...
        "avg_tbt_ms": statistics.fmean(per_token_times) * 1000 if per_token_times else 0.0,
        "p50_tbt_ms": _percentile(per_token_times, 0.5) * 1000 if per_token_times else 0.0,
        "p90_tbt_ms": _percentile(per_token_times, 0.9) * 1000 if per_token_times else 0.0,
